...
{
    public class UserTokensService : ITokensService<UserDTO>
    {
        private readonly IOptions<JobListTokenOptions> tokenOptions;
        private readonly IUnitOfWork uow;
        private readonly IMapper mapper;

        public UserTokensService(IUnitOfWork _uow, IMapper _mapper, IOptions<JobListTokenOptions> _tokenOptions)
        {
            uow = _uow;
            mapper = _mapper;
