...
namespace JobList.BusinessLogic.Services
{
    public class RecruitersService : IRecruitersService
    {
        ...
        public async Task<bool> ResetPasswordEntityByIdAsync(RecruiterResetPasswordRequest modelRequest, int id)
        {
            var entity = await _uow.RecruitersRepository.GetFirstOrDefaultAsync(
                filter: u => u.Id == id,
