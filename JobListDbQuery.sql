...
IF OBJECT_ID(N'dbo.RESUMES', N'U') IS NULL
	CREATE TABLE RESUMES(
		...
		CONSTRAINT FK_RESUMES_TO_USERS FOREIGN KEY (ID) REFERENCES USERS (ID) ON DELETE CASCADE,
...
IF OBJECT_ID(N'dbo.FAVORITE_VACANCIES', N'U') IS NULL
	CREATE TABLE FAVORITE_VACANCIES(
		...
		CONSTRAINT FK_FAVORITE_VACANCIES_TO_USERS FOREIGN KEY ([USER_ID]) REFERENCES USERS (ID) ON DELETE CASCADE
	);
GO